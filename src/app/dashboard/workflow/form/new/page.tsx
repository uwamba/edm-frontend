...
export default function CreateFormPage() {
  ...
  return (
    <DashboardLayout>
      <div className="p-6 max-w-4xl mx-auto bg-white text-gray-800 shadow-md rounded-md">
        <h1 className="text-3xl font-bold mb-6 text-center text-gray-900">📝 Create Form</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <h2 className="text-xl font-semibold mt-6 text-gray-700 border-b pb-2">Fields</h2>
              ...
              <div
                ...
                className={`p-4 rounded space-y-3 ${
                  field.parent_temp_id
                    ? 'ml-6 border-l-4 border-blue-400 bg-blue-50'
                    : 'border bg-gray-50'
                }`}
              >
                {field.parent_temp_id && (
                  <div className="text-sm text-blue-700 font-semibold italic mb-1">
                    ↳ Child Field of: <code>{field.parent_temp_id}</code>
                  </div>
                )}
                ...
                <input
                  ...
                  className="w-full border px-3 py-1 rounded focus:ring-2 focus:ring-blue-300"
                  required
                />
                ...
                {field.type === 'select' && field.parent_temp_id && (
                  <div className="space-y-1">
                    <label className="text-sm text-gray-700 font-medium">
                      Nested Options (value → comma-separated children)
                    </label>
                    <textarea
                      placeholder="Options (comma separated)"
                      value={field.options?.join(',') || ''}
          ...
          <div className="sticky bottom-0 bg-white py-4 flex justify-between border-t z-10">
            <button
              type="button"
